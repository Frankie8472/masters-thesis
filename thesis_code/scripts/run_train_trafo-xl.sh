...
# Job details
TIME=96:00  # HH:MM (default: 04:00, max: 240:00)
...
SCRIPT1="python /cluster/work/cotterell/knobelf/run_clm.py --model_type transfo-xl --tokenizer_name transfo-xl-wt103 --config_name transfo-xl-wt103 --output_dir /cluster/work/cotterell/knobelf/model-trafo_xl-wiki-integrated --do_train --do_eval --block_size 256 --overwrite_output_dir --dataset_name wikitext --dataset_config_name wikitext-103-raw-v1 --seed 42"
SCRIPT2="python /cluster/work/cotterell/knobelf/run_clm.py --model_type transfo-xl --tokenizer_name transfo-xl-wt103 --config_name transfo-xl-wt103 --output_dir /cluster/work/cotterell/knobelf/model-trafo_xl-wiki_nt --do_train --do_eval --block_size 256 --overwrite_output_dir --train_file /cluster/work/cotterell/knobelf/data/data_wikitext-103-raw/wiki.train.raw_no_titles.txt --validation_file /cluster/work/cotterell/knobelf/data/data_wikitext-103-raw/wiki.valid.raw_no_titles.txt --seed 42"
SCRIPT3="python /cluster/work/cotterell/knobelf/run_clm.py --model_type transfo-xl --tokenizer_name transfo-xl-wt103 --config_name transfo-xl-wt103 --output_dir /cluster/work/cotterell/knobelf/model-trafo_xl-wiki --do_train --do_eval --block_size 256 --overwrite_output_dir --train_file /cluster/work/cotterell/knobelf/data/data_wikitext-103-raw/wiki.train.raw.txt --validation_file /cluster/work/cotterell/knobelf/data/data_wikitext-103-raw/wiki.valid.raw.txt --seed 42"
